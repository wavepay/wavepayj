...
/**
 * A tool for comparing the blocks which are accepted/rejected by bitcoind/wavepayj
 * It is designed to run as a testnet-in-a-box network between a single bitcoind node and wavepayj
